...
const galleryItems = [
  ...
  {
    id: 4,
    image: 'https://images.unsplash.com/photo-1601924994987-69e26d50dc26?w=600&h=900&fit=crop',
    category: 'Process',
    title: 'Workshop Setup',
  },
  {
    id: 5,
    image: 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=600&h=800&fit=crop',
    category: 'Plushies',
    title: 'Mini Plushie Series',
  },
  {
    id: 6,
  ...
  {
    id: 10,
    image: 'https://images.unsplash.com/photo-1598300056393-4aac492f4344?w=600&h=900&fit=crop',
    category: 'Plushies',
  ...
  },
  {
    ...
    category: 'Keychains',
    title: 'Wooden Keychain Set',
  },
  {
    id: 12,
    image: 'https://images.unsplash.com/photo-1515378960530-7c0da6231fb1?w=600&h=600&fit=crop',
    category: 'Packaging',
                ...
                {galleryItems.find((item) => item.id === lightboxImage) && (
                  <div className="space-y-4">
                    ...
                    <div className="text-center text-white">
                      ...
                      <span className="inline-block px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm text-sm">
