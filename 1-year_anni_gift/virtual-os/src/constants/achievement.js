// thêm achievement mới: chỉ cần thêm 1 entry vào object ACHIEVEMENTS bên dưới
...
export const ACHIEVEMENTS = {
  ...
  open_quiz: { title: 'Kiểm tra độ hiểu nhau', description: 'Mở Quiz lần đầu tiên', icon: '❓', category: 'app' },
